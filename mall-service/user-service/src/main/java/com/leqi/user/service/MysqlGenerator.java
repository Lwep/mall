...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        // TODO 1.类路径与注释
        gc.setOutputDir(projectPath + "/mall-service/user-service/src/main/java");
        gc.setAuthor("Lwep");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://139.9.7.40:3306/mall_user?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true&failOverReadOnly=false&serverTimezone=GMT%2b8");
...
//        pc.setModuleName(scanner("模块名："));
        // 包名
        pc.setParent("com.leqi.user.service");
...
//                        + "/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
                return projectPath + "/mall-service/user-service/src/main/resources/mapper/"
                        + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
            }
        });
...
//        strategy .setSuperMapperClass("com.baomidou.mybatisplus.mapper.BaseMapper")
        ...
        // 自定义控制器基类地址
//        strategy.setSuperControllerClass("com.leqi.user.modules.system.controller.BaseController");
        // 设置控制器
